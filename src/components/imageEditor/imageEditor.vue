<template>
    <div class="screenBox">
        <div class="editorBox">
            ...
            <!--蒙层canvas-->
            <canvas id="canvasMask" :width="windowWidth" :height="windowHeight"></canvas>
            <!--用于导出图片的canvas-->
            <canvas id="resultImg" width="260" height="260" style="display: none"></canvas>
        </div>
        <div class="bottomBar" flex="main:justify cross:center">
      ...
      * */
      ...
      confirmImage(){
        ...
        nImg.onload = () => {
          ...
          /*最后导出裁切好的图片base64码*/
          this.$emit('editorResult',document.querySelector('#resultImg').toDataURL("image/jpeg"));
        }
      }
    },
